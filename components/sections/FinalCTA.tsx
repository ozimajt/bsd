export default function FinalCTA() {
  return (
    <section id="contact" aria-labelledby="cta-heading" className="border-t border-border py-32 sm:py-40 bg-background">
      <div className="max-w-6xl mx-auto px-4 text-center sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mb-12 text-lg leading-relaxed text-muted-foreground sm:text-xl md:text-2xl">
